...
import re222gr_assign3.re222gr.MyGML;
...
public class GeneratorMain {
	...
	public static void main(String[] args) throws Exception{
		...
		re222gr_assign3.graphs.DirectedGraph<Integer> g;
		
		
		re222gr_assign3.graphs.DirectedGraph<Integer> dg = gen.getSmallAcyclic();
	...
	private static void dump(re222gr_assign3.graphs.DirectedGraph<Integer> dg, String file_name) throws Exception{
		File f = new File(home,file_name);
		
		re222gr_assign3.graphs.GML<Integer> gml = new MyGML<Integer>(dg);
		gml.dumpGML(f);
	}
}
